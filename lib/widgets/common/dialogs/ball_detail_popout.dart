...
class BallDetailPopout extends StatefulWidget {
  // final BowlingBall ball;
  // const BallDetailPopout({Key? key, required this.ball}) : super(key: key);
  const BallDetailPopout({super.key});
  @override
  _BallDetailPopoutState createState() => _BallDetailPopoutState();
}

class _BallDetailPopoutState extends State<BallDetailPopout> {
  bool isFavorited = false; // 收藏狀態

  @override
  Widget build(BuildContext context) {
    return const Dialog(); // Placeholder
  }
}
                            ...
                            children: [
                              ...
                              Expanded(
                                child: _StatItem(
                                  ...
                                  label: 'RG差',
                                  value:
                                      widget.ball.differential?.toStringAsFixed(
                                        3,
                                      ) ??
                                      'N/A',
                                ),
                              ...
                              Expanded(
                                child: _StatItem(
                                  ...
                                  label: 'MB',
                                  value:
                                      widget.ball.massBias?.toStringAsFixed(
                                        3,
                                      ) ??
                                      'N/A',
                                ),
