...
class EditBallBagDialog extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final availableBags =
        BallBagType.values.where((bag) => bag != BallBagType.all).toList();
                              ...
                              data: (allBalls) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final ballsInBag = allBalls
                                        .where(
                                          (ball) => ball.bagType == bag,
                                        )
                                        .toList();
                                        ...
                                        trailing: PopupMenuButton<String>(
                                          ...
                                          onSelected: (value) {
                                            if (value == 'edit') {
                                              ...
                                              _showEditSpecificBagDialog(
                                                context,
                                                ref,
                                                bag,
                                              );
                                            } else if (value == 'delete') {
                                              _showDeleteBagConfirmation(
                                                context,
                                                ref,
                                                bag,
                                              );
  ...
  void _showEditSpecificBagDialog(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Edit ${bagType.displayName} functionality coming soon'),
      ),
    );
  }

  void _showDeleteBagConfirmation(
    BuildContext context,
    WidgetRef ref,
    BallBagType bagType,
  ) {
