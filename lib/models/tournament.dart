...
class Tournament {
  // List to store scores for each game
    ...
    return Tournament(
      ...
      endDate:
          json['endDate'] != null
              ...
              : null, // Parse endDate if not null
      type: TournamentType.values.firstWhere(
        (e) => e.toString() == json['type'],
        orElse: () => TournamentType.open,
      ), // Default if parsing fails
      openFormat:
          json['openFormat'] == null
              ? null
              : OpenTournamentFormat.values.firstWhere(
                (e) => e.toString() == json['openFormat'],
                orElse:
                    () =>
                        OpenTournamentFormat
                            .classic, // Provide a default non-null value for orElse
              ),
