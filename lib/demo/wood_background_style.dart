                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(16),
                            image: DecorationImage(
                              image: AssetImage(_backgrounds[1]), // 使用第二個木紋作為遮罩
                              fit: BoxFit.cover,
                              opacity: 0.06, // 極淡的木紋
                            ),
                          ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: List.generate(3, (index) {
                                  final isSelected = _currentBackgroundIndex == index;
                                ...
                                children: List.generate(3, (index) {
                                  return SizedBox(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 12,
                                        color: _currentBackgroundIndex == index 
                                          ? const Color(0xFF4E342E) // 深胡桃色
                                          : const Color(0xFF4E342E).withOpacity(0.6),
                                        fontWeight: _currentBackgroundIndex == index 
                                          ? FontWeight.bold 
                                          : FontWeight.normal,
                                      ),
                                    ),
                      ...
                      children: [
                        ...
                        Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(18),
                            image: DecorationImage(
                              image: AssetImage(_backgrounds[2]), // 使用第三個木紋作為遮罩
                              fit: BoxFit.cover,
                              opacity: 0.08, // 極淡的木紋
                            ),
                          ),
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(12),
                                      color: const Color(0xFF4E342E), // 深胡桃色
                                      boxShadow: [
                                        // 壓印圓形效果 (使用深陰影模擬)
                                        BoxShadow(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                            fontSize: 14,
                                            color: Color(0xFF4E342E), // 深胡桃色，稍微透明
                                          ),
                                        ),
                                      ],
                                    ),
                              ...
                              const Row(
                                ...
                                children: [
                                  _StatItem(label: '平均分數', value: '156', icon: Iconsax.chart_success, baseColor: Color(0xFFF4EEE8)),
                                  _StatItem(label: '全中次數', value: '8', icon: Iconsax.star, baseColor: Color(0xFFF4EEE8)),
                                  _StatItem(label: '補中次數', value: '12', icon: Iconsax.flash, baseColor: Color(0xFFF4EEE8)),
                                ],
                              ),
                            ],
                          ),
