...
class BallLibraryPageRefactored extends ConsumerStatefulWidget {
  const BallLibraryPageRefactored({super.key});

  @override
  ConsumerState<BallLibraryPageRefactored> createState() => _BallLibraryPageRefactoredState();
}

class _BallLibraryPageRefactoredState extends ConsumerState<BallLibraryPageRefactored> {
  @override
  void initState() {
    super.initState();
