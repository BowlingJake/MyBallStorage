...
_$UserProfileImpl _$$UserProfileImplFromJson(Map<String, dynamic> json) =>
    _$UserProfileImpl(
      ...
      dominateHand: json['dominate_hand'] as String?,
      style: json['style'] as String?,
      papInteger: (json['PAP_integer'] as num?)?.toInt(),
      papFraction: json['PAP_fraction'] as String?,
      papDirection: (json['PAP_direction'] as num?)?.toInt(),
      papDriftInteger: (json['PAP_drift_integer'] as num?)?.toInt(),
      papDriftFraction: json['PAP_drift_fraction'] as String?,
...
Map<String, dynamic> _$$UserProfileImplToJson(_$UserProfileImpl instance) =>
    <String, dynamic>{
      ...
      'city': instance.city,
      'dominate_hand': instance.dominateHand,
      'style': instance.style,
      'PAP_integer': instance.papInteger,
      'PAP_fraction': instance.papFraction,
      'PAP_direction': instance.papDirection,
      'PAP_drift_integer': instance.papDriftInteger,
      'PAP_drift_fraction': instance.papDriftFraction,
