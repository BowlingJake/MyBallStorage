...
LegacyGame _$LegacyGameFromJson(Map<String, dynamic> json) {
  return _LegacyGame.fromJson(json);
}
...
mixin _$LegacyGame {
  ...
  /// Serializes this LegacyGame to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of LegacyGame
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $LegacyGameCopyWith<LegacyGame> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LegacyGameCopyWith<$Res> {
  factory $LegacyGameCopyWith(
          LegacyGame value, $Res Function(LegacyGame) then) =
      _$LegacyGameCopyWithImpl<$Res, LegacyGame>;
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class _$LegacyGameCopyWithImpl<$Res, $Val extends LegacyGame>
    implements $LegacyGameCopyWith<$Res> {
  _$LegacyGameCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LegacyGameImplCopyWith<$Res>
    implements $LegacyGameCopyWith<$Res> {
  factory _$$LegacyGameImplCopyWith(
          _$LegacyGameImpl value, $Res Function(_$LegacyGameImpl) then) =
      __$$LegacyGameImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$LegacyGameImplCopyWithImpl<$Res>
    extends _$LegacyGameCopyWithImpl<$Res, _$LegacyGameImpl>
    implements _$$LegacyGameImplCopyWith<$Res> {
  __$$LegacyGameImplCopyWithImpl(
      _$LegacyGameImpl _value, $Res Function(_$LegacyGameImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$LegacyGameImpl implements _LegacyGame {
  const _$LegacyGameImpl(
      {required this.id,
  ...
  factory _$LegacyGameImpl.fromJson(Map<String, dynamic> json) =>
      _$$LegacyGameImplFromJson(json);
...
// 計分模式和狀態
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$LegacyGameImplCopyWith<_$LegacyGameImpl> get copyWith =>
      __$$LegacyGameImplCopyWithImpl<_$LegacyGameImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LegacyGameImplToJson(
      this,
    );
  }
}

abstract class _LegacyGame implements LegacyGame {
  const factory _LegacyGame(
      ...
      @JsonKey(name: 'current_frame')
      final int currentFrame}) = _$LegacyGameImpl;

  factory _LegacyGame.fromJson(Map<String, dynamic> json) =
      _$LegacyGameImpl.fromJson;
